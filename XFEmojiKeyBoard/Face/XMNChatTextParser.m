...
//        NSMutableAttributedString *atr = [NSMutableAttributedString yy_attachmentStringWithEmojiImage:emoticon attachmentSize:self.emotionSize alignToFont:self.alignFont alignment:self.alignment];
        ...
        NSMutableAttributedString *atr = [NSMutableAttributedString yy_attachmentStringWithContent:emoticon contentMode:UIViewContentModeScaleToFill attachmentSize:self.emotionSize alignToFont:self.alignFont alignment:self.alignment];
